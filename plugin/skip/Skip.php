 ...
 * in the totals and carries its reason in the result's failure message, so skipped tests are
 ...
 *   is skipped.
 * - A skipped test never requires an instance of the case class. A fully skipped class is
...
{
    /**
     * @param string $reason Why the test is skipped. Optional, but a reference to an issue
